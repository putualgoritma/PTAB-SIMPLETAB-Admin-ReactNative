              ...
              Alert.alert('Bukti Foto', `Galery atau Camera? `, [
                {
                  text: 'Galery',
                  onPress: () =>
                    props.ImageGalery(props.dataImage[index] ? index : null),
                },
                {
                  text: 'Camera',
                  onPress: () =>
                    props.Image(props.dataImage[index] ? index : null),
                },
              ]);
    ...
    <View>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            qty > 1 ? setQty(qty - 1) : alert('data tidak boleh dihapus');
            props.deleteImage();
          }}>
...
const AddTicket = ({navigation, route}) => {
  ...
  const [customer_id, setCustomer_id] = useState(
    formParams.customer_id ? formParams.customer_id : '',
  );
              ...
              <View style={styles.baseBoxShadow}>
                <View style={styles.boxShadow}>
                  ...
                  <Inpt
                    ...
                    onChangeText={item => handleForm('title', item)}
                  />
                  ...
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <RadioButton
                      ...
                      onPress={() =>
                        handleChecked('customer_id', customer_id, 'customer')
                      }
                      color="#087CDB"
                    />
                    ...
                    <RadioButton
                      value="noncustomer"
                      status={
                        checked === 'noncustomer' ? 'checked' : 'unchecked'
                      }
                      onPress={() =>
                        handleChecked(
                          'customer_id',
                  ...
                  {checked == 'customer' && (
                    <>
                      <Txt title="Pelanggan" />
                      <TouchableOpacity
                        style={styles.btnPelanggan}
                        onPress={() =>
                          navigation.navigate('SelectCustomer', {ticket: form})
                        }>
                        <Text style={{color: '#918F8FFF'}}>
                          {formParams.customer_name
                            ? formParams.customer_name
                            : 'Pilih Pelanggan'}
                        </Text>
                      </TouchableOpacity>
                  ...
                  <TxtArea
                    ...
                    onChangeText={item => handleForm('description', item)}
                  />
                  <Txt title="Ambil Gambar" />
                  <ButtonImage
                    Image={getImage}
                    ImageGalery={getImageGalery}
                    dataImage={responses}
                  ...
                  <View style={{paddingVertical: 10, height: 220}}>
                    ...
                    {video && <VideoPlayer src={{uri: video.uri}} />}
                  </View>
                    ...
                    <Button
                      ...
                      onPress={() =>
                        form.customer_id == '' || form.customer_id == null
                          ? alert('Mohon piling Pelanggan dahulu')
                          : Alert.alert(
                              'Peringatan',
