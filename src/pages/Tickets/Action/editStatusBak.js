          ...
          <Image
            ...
            source={
              props.image_done[indexdone] == null
                ? require('../../../assets/img/ImageFoto.png')
                : {uri: props.image_done[indexdone].uri}
            }
          />
        </View>
        {props.image_done[indexdone] == null && (
...
const EditStaff = ({navigation, route}) => {
  ...
  const deleteImageDone = () => {
    if (responses_done.length > 1) {
      ...
      setResponsesDone(
        responses_done.filter((item, indexdone) => indexdone !== lastIndexDone),
      );
    }
  };
                    ...
                    <View>
                      ...
                      <View style={{alignItems: 'center'}}>
                        <Image
                          style={{width: '90%', height: 200}}
                          source={
                            responses_frework[0] == null
                              ? require('../../../assets/img/ImageFoto.png')
                              : {uri: responses_frework[0].uri}
                          }
                        />
                      ...
                      <View style={{alignItems: 'center'}}>
                        <Image
                          style={{width: '90%', height: 200}}
                          source={
                            responses_tools[0] == null
                              ? require('../../../assets/img/ImageFoto.png')
                              : {uri: responses_tools[0].uri}
                          }
                        />
                        <Distance distanceV={10} />
                        <Button
